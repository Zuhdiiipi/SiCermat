    ...
    <div class="container my-4">
        ...
        <form method="GET" class="row g-3 mb-4">
            <div class="col-md-3">
                ...
                <select class="form-select" name="jenis_harga" id="jenis_harga">
            ...
            <div class="col-md-3">
                <label for="jenis_harga" class="form-label">Wilayah</label>
        ...
        {{-- Tombol Export --}}
        <div class="mb-3">
            <a href="{{ route('harga.download.pdf', $commodity->id) }}?jenis_harga={{ $jenisHarga }}&tanggal_awal={{ $tanggalAwal }}&tanggal_akhir={{ $tanggalAkhir }}"
